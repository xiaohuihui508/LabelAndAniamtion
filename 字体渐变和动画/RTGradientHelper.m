...
#import "RTGradientHelper.h"

@implementation RTGradientHelper

#pragma mark -- Linear Gradient
+ (UIImage *)getLinearGradientImage:(UIColor *)startColor and:(UIColor *)endColor directionType:(RTGradientDirection)directionType {
...
+ (UIImage *)getLinearGradientImage:(UIColor *)startColor and:(UIColor *)endColor directionType:(RTGradientDirection)directionType option:(CGSize)size {
    ...
    if (directionType == RTLinearGradientDirectionLevel) {
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 0);
    } else if (directionType == RTLinearGradientDirectionVertical) {
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(0, 1);
    } else if (directionType == RTLinearGradientDirectionUpwardDiagonalLine) {
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 1);
    } else if (directionType == RTLinearGradientDirectionDownDiagonalLine) {
...
+ (UIImage *)getRadialGradientImage:(UIColor *)centerColor and:(UIColor *)outColor option:(CGSize)size {
    ...
    CGFloat raduis = MAX(size.width / 2, size.height / 3);
